...
Реализует пункт 3 из [backlog.md](./backlog.md). Выполняется поверх дизайн-системы (`design-system.md` выполнен).
...
- Множественная загрузка / пакетная обработка — это batch-страница следующих фаз.
